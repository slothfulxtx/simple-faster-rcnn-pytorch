...
def decom_resnet101():
    ...
    net = resnet101(not opt.load_path)
    features = ResNet101Feature(net)
    classifier = ResNet101Classifier(net)
...
class ResNet101RoIHead(nn.Module):
    ...
    def __init__(self, n_class, roi_size, spatial_scale,classifier):
        ...
        self.cls_loc = nn.Linear(512*4, n_class*4)
        self.score = nn.Linear(512*4, n_class)
